...
import CourseFilerOneOpenLayout from '@/pages/course-filter-one-open'
      ...
      <ul className="mainmenu">
        <li className="with-megamenu has-menu-child-item position-static">
          <Link
            ...
            onClick={() => toggleMenuItem("/pages/marketplace")}
            href="/marketplace"
          >
            Home
        ...
        <li className="with-megamenu has-menu-child-item">
          <Link
            className={`${activeMenuItem === "/pages/instructor/instructor-dashboard" ? "open" : ""}`}
            href="/instructor/instructor-dashboard"
            onClick={() => toggleMenuItem("/pages/instructor/instructor-dashboard")}
          >
            Instructor
            {/* <i className="feather-chevron-down"></i> */}
          </Link>
        ...
        <li className="with-megamenu has-menu-child-item">
          <Link
            className={`${activeMenuItem === "/pages/student/student-dashboard" ? "open" : ""}`}
            href="/student/student-dashboard"
            onClick={() => toggleMenuItem("/pages/student/student-dashboard")}
          >
            Student
            {/* <i className="feather-chevron-down"></i> */}
          </Link>
        ...
        <li className="with-megamenu has-menu-child-item position-static">
          <Link
            href="/blog-grid"
            className={`${activeMenuItem === "/blog-grid" ? "open" : ""}`}
            onClick={() => toggleMenuItem("/blog-grid")}
          >
            Blog
            {/* <i className="feather-chevron-down"></i> */}
          </Link>
